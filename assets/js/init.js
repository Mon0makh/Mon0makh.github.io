...
/** Registration Form **/
	...
	{ 
		...
		if(person_name == ""){ 
			var error1 = '<div class="enter-name col-lg-3 align-center"> Введите Имя </div>';
		...
		if(user_email== ""){
			var error2 = '<div class="enter-email col-lg-3 align-center"> Введите email </div>';
			jQuery("#result").hide().html(error2).fadeIn(500);
			proceed = false;
			
		}
		else if(!filter.test(user_email)) {
			var invalid = '<div class="invalid-email col-lg-3 align-center"> Некорекный Email </div>';
